...
public class Order {
    ...
    public Order(int numCoperti, Table table) {
        ...
        if (table.numMaxCoperti() <= numCoperti)
    ...
    public double getTotal() {
        return this.orderedProducts.stream().mapToDouble(Item::price).sum() + (this.table.costoCoperto() * this.numCoperti);
    }
    ...
    public void print() {
        ...
        System.out.println("numero tavolo--> " + this.table.numTable());
